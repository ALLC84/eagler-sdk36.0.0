      ...
      const docRef = DB.collection("users").doc(userId);
		docRef
			...
			.then(doc => {
               ...
               console.log('TCL: -----------------------------------------------------------------------------')
               console.log('TCL: functionUserProfile -> defineTiempoHabilidades -> El documento esta vacio')
               console.log('TCL: -----------------------------------------------------------------------------')
				}
			})
			.catch(function(error) {
            console.log('TCL: ------------------------------------------------------------------------')
            console.log('TCL: functionUserProfile -> staticdefineTiempoHabilidades -> error', error)
            console.log('TCL: ------------------------------------------------------------------------')
			});
   }
